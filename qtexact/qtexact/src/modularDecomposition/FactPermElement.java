 ...
 */
class FactPermElement<V> extends RootedTreeNode<V> {
	...
	protected FactPermElement() {
		...
		numMarks = 0;
		neighbours = new LinkedList<FactPermElement<V>>();
	}
	 ...
	 */
	protected void addNeighbour(FactPermElement<V> neighbour) {
	 ...
	 */
	protected void replaceNeighbours(LinkedList<FactPermElement<V>> newNeighbours) {
		neighbours = newNeighbours;
	}
	
	
	/* Returns this element's neighbours. */
	protected LinkedList<FactPermElement<V>> getNeighbours() {
		return neighbours;
	}
	
	
	/* Sets this element's mu value. */
	protected void setMu(FactPermElement<V> mu) {
		this.mu = mu; 		
	}

	
	/* Returns this element's mu value. */
	protected FactPermElement<V> getMu() {
		return mu;
	}
	...
	public String toString() {
		...
		if (index != DEFAULT_INDEX) {
			...
			Iterator<FactPermElement<V>> neighIt = neighbours.iterator();
