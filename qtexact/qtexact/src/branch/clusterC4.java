...
public class clusterC4<V> extends clusterBranch<V> 
{

	public clusterC4(Controller<V> controller) {
		super(controller);
	...
	public branchingReturnC<V> branchingRules(branchingReturnC<V> s, SearchResult<V> searchResult)
	{
		...
		//check if C4 is present
		if (certificate.getFlag() == -1)
		{
				...
				&& !s.getChanges().contains(new myEdge<V>(new Pair<V>(lexResult.get(2), lexResult.get(1)), true, directed)))
			{
				...
				addResult(s, lexResult.get(0), lexResult.get(2));
				deleteResult(s, lexResult.get(1), lexResult.get(0));
				...
				&& !s.getChanges().contains(new myEdge<V>(new Pair<V>(lexResult.get(2), lexResult.get(3)), true, directed)))
			{
				...
				addResult(s, lexResult.get(0), lexResult.get(2));
				deleteResult(s, lexResult.get(0), lexResult.get(3));
